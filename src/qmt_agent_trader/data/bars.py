...
def load_daily_bars(
    ...
    *,
    ...
    raw = lake.read_layer_prefix("raw", "tushare_daily_")
    ...
    bars = enrich_trade_states(
        bars,
        suspend=lake.read_layer_prefix("raw", "tushare_suspend_"),
        stk_limit=lake.read_layer_prefix("raw", "tushare_stk_limit_"),
