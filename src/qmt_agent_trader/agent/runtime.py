...
def _default_research_system_prompt() -> str:
    return (
        ...
        "instead of narrowing the research question. For cyclical baskets, use query_universe with "
        ...
        "data, or review_required=true, disclose it. Do not describe a strategy or factor "
        "as significant, best, validated, or recommended when diagnostics fail or "
        "predictive evidence is not computed; use failed candidate, blocked candidate, "
        "incomplete candidate, research-only candidate, or needs repair instead of "
        "最优/最佳/最好/推荐/有效/稳健 for those paths. If you need "
