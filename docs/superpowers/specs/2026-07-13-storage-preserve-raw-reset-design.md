...
Planning is read-only and deterministic. It inventories current and known legacy reset roots,
rejects symbolic links, non-Parquet raw files, and corrupt raw data, hashes every deleted and preserved file, and returns a confirmation
